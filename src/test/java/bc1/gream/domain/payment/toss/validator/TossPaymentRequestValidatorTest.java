...
class TossPaymentRequestValidatorTest {
    ...
    public void 토스페이결제초기요청_검증_해피케이스() {
        // GIVEN
        TossPaymentInitialRequestDto requestDto = new TossPaymentInitialRequestDto(3000L, OrderName.CHARGE_POINT);
...
//        // GIVEN
//        TossPaymentInitialRequestDto requestDto = new TossPaymentInitialRequestDto(3000L,
...
//    }
    ...
    public void 토스페이결제초기요청_검증_언해피케이스_결제금액() {
        // GIVEN
        TossPaymentInitialRequestDto zeroAmountRequest = new TossPaymentInitialRequestDto(0L, OrderName.CHARGE_POINT);
        TossPaymentInitialRequestDto negativeAmountRequest = new TossPaymentInitialRequestDto(-1000L, OrderName.CHARGE_POINT);
