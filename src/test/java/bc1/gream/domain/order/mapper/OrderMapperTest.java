...
class OrderMapperTest implements OrderTest {
    ...
    public void 주문_toTradeResponseDto() {
        ...
        // THEN
        assertEquals(TEST_ORDER_FINAL_PRICE, orderTradeResponseDto.orderFinalPrice());
        assertEquals(TEST_ORDER.getCreatedAt(), orderTradeResponseDto.orderTradeDate());
    }
    ...
    public void 사용자가판매한내역Dto_매핑() {
        ...
        UserSalesHistroyResponseDto responseDto = orderMapper.toOrderAsSellerResponseDto(TEST_ORDER);

        // THEN
        assertEquals(TEST_ORDER_ID, responseDto.orderId());
        assertEquals(TEST_ORDER_FINAL_PRICE, responseDto.orderFinalPrice());
        assertEquals(TEST_ORDER.getCreatedAt(), responseDto.orderTradedDate());
        ...
        assertEquals(TEST_PRODUCT_IMAGE_URL, responseDto.productIamgeUrl());
    }
}